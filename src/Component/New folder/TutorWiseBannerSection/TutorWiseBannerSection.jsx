...
const Contact = () => {
    return (
        <div className="bg-white text-white min-h-screen flex flex-col items-center p-6 mb-14">
            {/* Title */}
    ...
    <div className="absolute -bottom-28 left-1/2 transform -translate-x-1/2 w-full flex justify-center">
        <div className="grid grid-cols-2 sm:grid-cols-2 md:grid-cols-2 lg:grid-cols-4 gap-8">
            ...
            <div className="bg-white text-black rounded-lg shadow-lg p-4 text-center w-full">
                ...
                <div className="py-2">
                    <p className="text-sm text-gray-400">Mobile: (+88) - 0000 - 1111</p>
                    <p className="text-sm text-gray-400">Hotline: 12345 - 2233</p>
                </div>
            </div>
            ...
            <div className="bg-white text-black rounded-lg shadow-lg p-4 text-center w-full">
                ...
                <div className="py-2">
                    ...
                    <p className="text-sm text-gray-400">1205, Mirpur</p>
                </div>
            </div>
            ...
            <div className="bg-white text-black rounded-lg shadow-lg p-4 text-center w-full">
                ...
                <div className="py-2">
                    <p className="text-sm text-gray-400">Saturday - Friday</p>
                    <p className="text-sm text-gray-400">10:30am - 22:00pm</p>
                </div>
            </div>
        </div>
    </div>
